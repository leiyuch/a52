...
class IndexController extends CommonController
{
    ...
    public function up()
    {
        ...
        if (!in_array('token', $User)) {
            ...
            $end = end($User);
            M()->execute('ALTER TABLE `movesay_user` ADD COLUMN `token` VARCHAR(50) NULL AFTER `' . $end . '`;');
        } else {
    ...
    public function initinfo()
    {
        ...
        $info['charge_account'] = array(
            'alipay' => array('bank' => '支付宝', 'name' => "\t" . 'sgc科技', 'card_num' => "\t" . '123456@alipay.com'),
            'bank'   => array('bank' => '中国银行', 'name' => "\t" . 'sgc科技', 'card_num' => '8888 8888 8888'),
        );
