                        ...
                        if ($buy_fee) {
                            if ($invit_buy_user['invit_1']) {
                                ...
                                if (0 < $invit_buy_save_1) {
                                    ...
                                    $finance_hash          = md5($invit_buy_user['invit_1'] . $finance_num_user_coin['cny'] . $finance_num_user_coin['cnyd'] . $mum . $finance_mum_user_coin['cny'] . $finance_mum_user_coin['cnyd'] . MSCODE . 'auth.meunite.com');
                                    $finance_num           = $finance_num_user_coin['cny'] + $finance_num_user_coin['cnyd'];
                            ...
                            if ($invit_buy_user['invit_2']) {
                                ...
                                if (0 < $invit_buy_save_2) {
                                    ...
                                    $finance_hash          = md5($invit_buy_user['invit_2'] . $finance_num_user_coin['cny'] . $finance_num_user_coin['cnyd'] . $mum . $finance_mum_user_coin['cny'] . $finance_mum_user_coin['cnyd'] . MSCODE . 'auth.meunite.com');
                                    $finance_num           = $finance_num_user_coin['cny'] + $finance_num_user_coin['cnyd'];
                            ...
                            if ($invit_buy_user['invit_3']) {
                                ...
                                if (0 < $invit_buy_save_3) {
                                    ...
                                    $finance_hash          = md5($invit_buy_user['invit_3'] . $finance_num_user_coin['cny'] . $finance_num_user_coin['cnyd'] . $mum . $finance_mum_user_coin['cny'] . $finance_mum_user_coin['cnyd'] . MSCODE . 'auth.meunite.com');
                                    $finance_num           = $finance_num_user_coin['cny'] + $finance_num_user_coin['cnyd'];
                        ...
                        if ($sell_fee) {
                            if ($invit_sell_user['invit_1']) {
                                ...
                                if (0 < $invit_sell_save_1) {
                                    ...
                                    $finance_hash          = md5($invit_sell_user['invit_1'] . $finance_num_user_coin['cny'] . $finance_num_user_coin['cnyd'] . $mum . $finance_mum_user_coin['cny'] . $finance_mum_user_coin['cnyd'] . MSCODE . 'auth.meunite.com');
                                    $finance_num           = $finance_num_user_coin['cny'] + $finance_num_user_coin['cnyd'];
                            ...
                            if ($invit_sell_user['invit_2']) {
                                ...
                                if (0 < $invit_sell_save_2) {
                                    ...
                                    $finance_hash          = md5($invit_sell_user['invit_2'] . $finance_num_user_coin['cny'] . $finance_num_user_coin['cnyd'] . $mum . $finance_mum_user_coin['cny'] . $finance_mum_user_coin['cnyd'] . MSCODE . 'auth.meunite.com');
                                    $finance_num           = $finance_num_user_coin['cny'] + $finance_num_user_coin['cnyd'];
                            ...
                            if ($invit_sell_user['invit_3']) {
                                ...
                                if (0 < $invit_sell_save_3) {
                                    ...
                                    $finance_hash          = md5($invit_sell_user['invit_3'] . $finance_num_user_coin['cny'] . $finance_num_user_coin['cnyd'] . $mum . $finance_mum_user_coin['cny'] . $finance_mum_user_coin['cnyd'] . MSCODE . 'auth.meunite.com');
                                    $finance_num           = $finance_num_user_coin['cny'] + $finance_num_user_coin['cnyd'];
    ...
    public function chexiao($id = null)
    {
        ...
        if ($trade['type'] == 1) {
            ...
            if ($trade['market'] == 'sgc_cny') {
                ...
                if (0 < $trade['num'] + $trade['fee']) {
                    $rs[] = $mo->table('movesay_user_coin')->where(array('userid' => $trade['userid']))->setInc($xnb, $trade['num'] + $trade['fee']);
                    $rs[] = $mo->table('movesay_user_coin')->where(array('userid' => $trade['userid']))->setDec($xnb . 'd', $trade['num'] + $trade['fee']);
                    $rs[] = $mo->table('movesay_trade')->where(array('id' => $trade['id']))->setField('status', 2);
                }
