...
class ArticleController extends HomeController
{
	public function index($id = NULL)
	{
		...
		if (LANG_SET == 'en' && !empty($Articletype['en_title'])) {
			$Articletype['title'] = $Articletype['en_title'];
		}
		...
		foreach ($ArticleTypeList as $k => $v) {
			if (LANG_SET == 'en' && !empty($v['en_title'])) {
				$v['title'] = $v['en_title'];
			}
		...
		foreach ($list as $key => $value) {
			if (LANG_SET == 'en' && !empty($value['en_title'])) {
				$list[$key]['title'] = $value['en_title'];
			}
		}
	...
	public function detail($id = NULL)
	{
		...
		if (LANG_SET == 'en' && !empty($data['en_title'])) {
	...
	public function type($id = NULL)
	{
		...
		if (LANG_SET == 'en' && !empty($Articleaa['en_title'])) {
			$Articleaa['title'] = $Articleaa['en_title'];
			$Articleaa['content'] = $Articleaa['en_content'];
			$shang['title'] = $shang['en_title'];
		}
