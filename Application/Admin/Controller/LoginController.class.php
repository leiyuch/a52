...
class LoginController extends \Think\Controller
{
	...
	public function index($username = NULL, $password = NULL, $verify = NULL, $movesay = NULL,$mverify = NULL)
	{
		if (IS_POST) {
 ...
 // return; 	
    ...
    // $response=sendMsg('15369195442','77777777');
    // $this->error($response['Code']);
			...
			// if ($mverify!=session('admin_verify')) {
			// 	$this->error('短信验证码错误');
			// }
			...
			if (ADMIN_KEY && ($movesay != ADMIN_KEY)) {
