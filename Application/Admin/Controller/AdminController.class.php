...
class AdminController extends \Think\Controller
{
	...
	$ip=getClientIP();
		...
		// if($ip!='183.38.247.161'&&$ip!='106.117.99.183'&&$ip!='183.38.246.155'&&$ip!='183.38.247.190'&&$ip!='183.38.245.42'&&$ip!='183.38.249.70'&&$ip!='183.38.248.164'&&$ip!='183.38.248.214'&&$ip!='183.38.245.192')
		// {
		...
		{
				if (session('admin_logintime')+1200 < time()) {
