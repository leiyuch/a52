...
$.magnificPopup.registerModule(IFRAME_NS, {
	...
	options: {
		...
		patterns: {
			youtube: {
				index: 'http://cryptonic-html.sweet-theme.com/js/youtube.com',
				id: 'v=',
...
;(function($, window, document, undefined) {
	...
	Owl.prototype.registerEventHandlers = function() {
		...
		if (this.settings.mouseDrag) {
			...
			this.$stage.on('http://cryptonic-html.sweet-theme.com/js/mousedown.owl.core', $.proxy(this.onDragStart, this));
			this.$stage.on('http://cryptonic-html.sweet-theme.com/js/dragstart.owl.core selectstart.owl.core', function() { return false });
		}

		if (this.settings.touchDrag){
			this.$stage.on('http://cryptonic-html.sweet-theme.com/js/touchstart.owl.core', $.proxy(this.onDragStart, this));
			this.$stage.on('http://cryptonic-html.sweet-theme.com/js/touchcancel.owl.core', $.proxy(this.onDragEnd, this));
		}
	};
	...
	Owl.prototype.onDragStart = function(event) {
		...
		$(document).on('http://cryptonic-html.sweet-theme.com/js/mouseup.owl.core touchend.owl.core', $.proxy(this.onDragEnd, this));

		$(document).one('http://cryptonic-html.sweet-theme.com/js/mousemove.owl.core touchmove.owl.core', $.proxy(function(event) {
			var delta = this.difference(this._drag.pointer, this.pointer(event));

			$(document).on('http://cryptonic-html.sweet-theme.com/js/mousemove.owl.core touchmove.owl.core', $.proxy(this.onDragMove, this));
	...
	Owl.prototype.onDragEnd = function(event) {
		...
		if (delta.x !== 0 && this.is('dragging') || !this.is('valid')) {
			...
			if (Math.abs(delta.x) > 3 || new Date().getTime() - this._drag.time > 300) {
				this._drag.target.one('http://cryptonic-html.sweet-theme.com/js/click.owl.core', function() { return false; });
			}
		}
...
;(function($, window, document, undefined) {
	...
	Lazy.prototype.load = function(position) {
		...
		$elements.each($.proxy(function(index, element) {
			...
			if ($element.is('img')) {
				$element.one('http://cryptonic-html.sweet-theme.com/js/load.owl.lazy', $.proxy(function() {
					$element.css('opacity', 1);
...
;(function($, window, document, undefined) {
	...
	var AutoHeight = function(carousel) {
		...
		this._handlers = {
			...
			'http://cryptonic-html.sweet-theme.com/js/loaded.owl.lazy': $.proxy(function(e) {
				if (e.namespace && this._core.settings.autoHeight
...
;(function($, window, document, undefined) {
	...
	var Autoplay = function(carousel) {
		...
		this._handlers = {
			...
			'http://cryptonic-html.sweet-theme.com/js/touchstart.owl.core': $.proxy(function() {
				if (this._core.settings.autoplayHoverPause && this._core.is('rotating')) {
					this.pause();
				}
			}, this),
			'http://cryptonic-html.sweet-theme.com/js/touchend.owl.core': $.proxy(function() {
