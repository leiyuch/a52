		...
		<section class="box-content">
			    ...
			    <div class="main-content clearfix">
				    <div class="now"> 
					    ...
					    <a href="<?php echo U('User/index');?>" class="movesay"><?php echo L('security');?> </a> &gt; <?php echo L('user_set_trade_password_enter');?> 
				    </div>
                 ...
                 <li><a href="<?php echo U('User/log');?>"><i class="fa fa-circle-o"></i> <?php echo L('user_login_log');?></a></li>
				    ...
				    <div class="tag-list-content assets_content bg_w"> 
				     <div class="safe_center clear"> 
				      	<h1> <span> <?php echo L('user_set_trade_password_enter');?> </span> <span> <a class="right" onclick="$('#hints').slideToggle();"> <i class="fa fa-hand-o-right move fz_14 mr5"></i> <span class="fz_12 move">帮助</span> </a> </span> </h1> 
				     </div> 
				     
				     <div id="hints" class="mytips"> 
					      <p><span style="color:#0096E0;line-height:21px;background-color:#FFFFFF;"><span> </span></span></p>
					      <h1 style="font-weight:normal;font-family:tahoma, 'Microsoft YaHei', Arial, Helvetica, sans-serif;font-size:20px;color:#333333;background-color:#FFFFFF;"> <span style="color:#9933E5;"><h1  style="white-space: normal; background-color: rgb(255, 255, 255); font-weight: normal;"><span style="font-size:14px;color:#666666;"><?php echo L('user_tpwdset');?></span> </h1> </span> </h1> 
					      <p></p> 
					 </div> 
					 <div class="mytable-body"> 
					      ...
					      <div class="step2 set_verify mt30" style=""> 
						       <ul> 
						        <li><?php echo L('user_tpwdset_cvm');?>:</li> 
						        <li> <label><input type="radio" name="tpwdsetting" value="1" style="vertical-align: -2px;" checked="checked" /> <?php if(($user['tpwdsetting']) == "1"): endif; echo L('user_set_trade_password_op1');?> </label></li> 
						        <li> <label><input type="radio" name="tpwdsetting" value="2" style="vertical-align: -2px;" /> <?php if(($user['tpwdsetting']) == "2"): ?>checked="checked"<?php endif; ?> <?php echo L('user_set_trade_password_op2');?> </label></li> 
						        <li> <label><input type="radio" name="tpwdsetting" value="3" style="vertical-align: -2px;" /> <?php if(($user['tpwdsetting']) == "3"): ?>checked="checked"<?php endif; ?> <?php echo L('user_set_trade_password_op3');?> </label></li> 
						        <li> 
						         <div class="mt5 mb5 "> 
						          <input id="paypassword" value="<?php echo L('enter_trade_password');?>" placeholder="请输入交易密码" type="password" class="texts" />
						          <!-- <a href="/Findpwd/findTradePwd" class="move ml5">忘记密码?</a>  -->
						         </div> </li> 
						        <li> 
						         <div class="mt10 mb10 "> 
						          <input class="btns2" value=" <?php echo l('save');?>" type="button"  onclick="Update()" /> 
						         </div> </li> 
						       </ul> 
					      </div> 
					 </div> 
...
<span id="go_to_top" class="go-to-top"><i class="fa fa-long-arrow-up"></i></span>
	...
	function Update(){
		...
		if(tpwdsetting==""||tpwdsetting==null){
			layer.tips('<?php echo L('user_please_select_one');?>','#tpwdsetting',{tips : 3 });
			return false;
		}

		$.post("<?php echo U('User/uptpwdsetting');?>",{paypassword : paypassword,tpwdsetting : tpwdsetting },function(data){
			if(data.status==1){
				layer.msg(data.info,{icon : 1 });
				window.location="<?php echo U('User/tpwdset');?>";
			}else{
