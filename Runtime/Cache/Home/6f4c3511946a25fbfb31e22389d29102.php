		...
		<section class="box-content">
			    ...
			    <div class="main-content clearfix">
				    <div class="now"> 
					    ...
					    <a href="<?php echo U('User/index');?>" class="movesay"><?php echo L('security');?> </a> &gt; <?php echo L('user_modify_trade_password');?> 
				    </div>
                 ...
                 <li><a href="<?php echo U('User/log');?>"><i class="fa fa-circle-o"></i> <?php echo L('user_login_log');?></a></li>
				    ...
				    <div class="tag-list-content assets_content bg_w"> 
				     <div class="safe_center clear"> 
				      	<h1> <span> <?php echo L('user_modify_trade_password');?> </span> <span> <a class="right" onclick="$('#hints').slideToggle();"> <i class="fa fa-hand-o-right move fz_14 mr5"></i> <span class="fz_12 move">帮助</span> </a> </span> </h1> 
				     </div> 
				     ...
				     <div class="step1 pwtrade mt40" style="display: block;">
	                    <dl>
	                        ...
	                        <dd>
	                            <input type="password" tabindex="2" id="oldpaypassword" class="texts">
	                        </dd>
	                    </dl>
	                    <dl>
	                        <dt><?php echo L('user_new_trade_password');?>：</dt>
	                        <dd>
...
<span id="go_to_top" class="go-to-top"><i class="fa fa-long-arrow-up"></i></span>
	...
	<script>
	function Update(){
		$.post("<?php echo U('User/uppaypassword');?>",{oldpaypassword : $('#oldpaypassword').val(),newpaypassword : $('#newpaypassword').val(),repaypassword : $('#repaypassword').val() },function(data){
			if(data.status==1){
