	...
	<div class="register" style="border-radius: 15px; margin-bottom: 20px;">
		<table>
			<tbody>
				...
				<tr>
					<th align="right"><?php echo L('secure_phone');?>：</th>
					<td><div class="formbody" style="width: 250px;">
							<i class="icon_phone"></i>
							<input type="text" class="username" id="moble" name="moble" placeholder="<?php echo L('enter_binding_phone');?>">
						</div></td>
				</tr>
				<tr>
				...
				<tr>
					<th align="right"><?php echo L('sms_code');?>：</th>
					<td><div class="formbody">
							<i class="icon_code"></i>
				...
				<tr>
					<th align="right"><?php echo L('user_new_trade_password');?>：</th>
					<td><div class="formbody" style="width: 250px;">
				...
				<tr>
					<th align="right"><?php echo L('user_confirm_trade_password');?>：</th>
					<td><div class="formbody" style="width: 250px;">
							<i class="icon_password"></i>
							<input type="password" class="password" id="repassword" name="password" placeholder="<?php echo L('user_enter_trade_password_again');?>">
						</div></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td><div class="formbody">
							<input type="button" class="movesay_btn" name="index_submit" id="Submin" onclick="Update();" value="<?php echo L('user_find_trade_password');?>" title="<?php echo L('user_find_trade_password');?>" style="width: 320px;">
						</div></td>
					<td>&nbsp;</td>
				</tr>
			</tbody>
...
<script>
	function SendCode(){
		...
		$.post("<?php echo U('Verify/findpaypwd');?>",{username:username,moble:moble,verify:verify},function(data){
			if(data.status==1){
	...
	function Update(){
		...
		$.post("<?php echo U('Login/findpaypwd');?>",{username:username,moble:moble,moble_verify:moble_verify,verify:verify,password:password,repassword:repassword},function(data){
			if(data.status==1){
				layer.msg(data.info,{icon:1});
