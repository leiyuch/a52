    ...
    <div class="form" style="height:395px">
        ...
        <div class="input register_email">
                <div class="part4 text-center">
                        <h3 style="font-size: 16px;padding-top: 60px;">恭喜用户<span style="color:red;"><?php echo ($user["username"]); ?></span>，您已经注册成功</h3>
                        <p style="padding-top: 39px;"> <strong id="times" class="f-size18"></strong> 点击，跳转到 <a href="/finance/" class="c-blue" style="color:#1997d7">用户中心</a></p>
