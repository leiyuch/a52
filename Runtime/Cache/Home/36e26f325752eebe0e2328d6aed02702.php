...
<body>
			...
			<div id="control">
				<div class="inner">
					<ul id="periods" class="horiz">
						<li style='line-height: 26px'><?php echo L('trade_k_line_times');?>:</li>
						<li class="period"><a>1<?php echo L('trade_k_line_week');?></a></li>
						<li class="subsep"></li>
						<li class="period"><a>1<?php echo L('trade_k_line_day');?></a></li>
						<li class="subsep"></li>
						<li class="period"><a>12<?php echo L('trade_k_line_hours');?></a></li>
						<li class="period"><a>6<?php echo L('trade_k_line_hours');?></a></li>
						<li class="period"><a>4<?php echo L('trade_k_line_hours');?></a></li>
						<li class="period"><a>2<?php echo L('trade_k_line_hours');?></a></li>
						<li class="period"><a>1<?php echo L('trade_k_line_hours');?></a></li>
						<li class="subsep"></li>
						<li class="period"><a>30<?php echo L('trade_k_line_minute');?></a></li>
						<li class="period selected"><a>15<?php echo L('trade_k_line_minute');?></a></li>
						<li class="period"><a>5<?php echo L('trade_k_line_minute');?></a></li>
						<li class="period"><a>3<?php echo L('trade_k_line_minute');?></a></li>
						<li class="period"><a>1<?php echo L('trade_k_line_minute');?></a></li>
						<li class="subsep"></li>
						<li>
							<div class="dropdown">
								<div class="t"><?php echo L('trade_k_line_page_set');?></div>
								<div class="dropdown-data">
									<table class="nowrap simple settings">
										<tbody>
											<tr class="main_lines">
												<td><?php echo L('trade_k_line_line_set');?></td>
												<td><ul id="setting_main_lines">
														<li value="mas" class="active">MA</li>
														<li value="emas">EMA</li>
														<li value="none"><?php echo L('trade_k_line_close_line');?></li>
													</ul></td>
											</tr>
											<tr class="stick_style">
												<td><?php echo L('trade_k_line_style');?></td>
												<td><ul id="setting_stick_style">
														<li value="candle_stick" class="active"><?php echo L('trade_k_line');?>-OHLC</li>
														<li value="candle_stick_hlc"><?php echo L('trade_k_line');?>-HLC</li>
														<li value="ohlc">OHLC</li>
														<li value="line"><?php echo L('trade_k_line_single');?></li>
														<li value="line_o"><?php echo L('trade_k_line_single');?>-o</li>
														<li value="none"><?php echo L('trade_k_line_close_photo');?></li>
													</ul></td>
											</tr>
											...
											<tr class="indicator">
												<td><?php echo L('trade_k_line_quota');?></td>
												<td><ul id="setting_indicator">
														<li value="macd">MACD</li>
														<li value="kdj">KDJ</li>
														<li value="stoch_rsi" class="active">StochRSI</li>
														<li value="none"><?php echo L('trade_k_line_close_quota');?></li>
													</ul></td>
											</tr>
											<tr class="scale">
												<td><?php echo L('trade_k_line_ratio');?></td>
												<td><ul id="setting_scale">
														<li value="normal"><?php echo L('trade_k_line_normal');?></li>
														<li value="logarithmic" class="active"><?php echo L('trade_k_line_logarithm');?></li>
													</ul></td>
											</tr>
											<tr>
												<td></td>
												<td colspan="2"><a id="btn_settings"><?php echo L('trade_k_line_quota_set');?></a></td>
											</tr>
										</tbody>
									</table>
								</div>
							...
							<div class="dropdown">
								<div class="t"><?php echo L('trade_k_line_tool');?></div>
								<div class="dropdown-data">
									<table class="nowrap simple">
										<tbody>
											<tr>
												<td><a class="mode" mode="draw_line"><?php echo L('trade_k_line_draw');?></a><br> <a class="mode" mode="draw_fhline"><?php echo L('trade_k_line_draw1');?></a> <br> <a class="mode" mode="draw_ffan"><?php echo L('trade_k_line_draw2');?></a><br> <a class="mode selected" mode="draw_fhlineex"><?php echo L('trade_k_line_draw3');?></a>
													<div class="hint">
														<?php echo L('trade_k_line_click_left');?> <br><?php echo L('trade_k_line_click_right');?>
													</div></td>
											</tr>
										</tbody>
									</table>
						...
						<li class="sep"></li>
						<li>
							<?php echo L('trade_k_line_has_update');?>
							<span id="change">12</span>
							<?php echo L('trade_k_line_second');?>
	...
	<div id="settings">
		<h2><?php echo L('trade_k_line_quota_set_1');?></h2>
		<table>
...
Set field blank to remove one of the indicators.">?</abbr>
				...
				<td><button><?php echo L('trade_k_line_default_value');?></button></td>
			</tr>
		...
		(function(){
			...
			setTimeout(function(){
				if(!window.$script_loaded){
					return document.getElementById('loading').innerHTML="<div class=inner><?php echo L('trade_k_line_loading');?>...</div>";
				}
			},1000);
			var goaa=null;
			var waita=seconda=7;
			goaa=setInterval(function(){
				...
				if(waita<0){
					clearInterval(goaa);
					$.get("/Chart/setTradeJson?market="+$market+"&t="+(new Date().getTime()),function(data){
					});
					waita=seconda;
				}
			},1000);
