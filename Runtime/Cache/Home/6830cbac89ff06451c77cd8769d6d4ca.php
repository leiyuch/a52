                 ...
                 <li><a href="<?php echo U('User/log');?>"><i class="fa fa-circle-o"></i> <?php echo L('user_login_log');?></a></li>
				    ...
				    <div class="tag-list-content assets_content bg_w"> 
				     <div class="safe_center clear"> 
				      	<h1> <span> <?php echo L('security');?> </span> <span> <a class="right" onclick="$('#hints').slideToggle();"> <i class="fa fa-hand-o-right move fz_14 mr5"></i> <span class="fz_12 move">帮助</span> </a> </span> </h1> 
				     </div> 
				     
				     
				     <div id="hints" class="mytips"> 
      
					      <p><span><span style="background-color:#FFFFFF;font-size:14px;color:#666666;"> <?php echo L('user_index');?> </span></span></p> 
					     </div> 
					     <ul class="sc_statu"> 
					        <li> 
					         <dl> 
							
										<dt><?php echo L('real_name');?>：<?php echo ($user["truename"]); ?></dt>
										<dt><?php echo L('user_name');?>：<?php echo ($user["username"]); ?></dt>
					         </dl> </li> 
					       <li> 
							    <?php if(empty($user['moble'])): ?><em class="sc_statu_type_2"></em>
										<dl>
											<dt><?php echo L('bound_phone');?></dt>
											<dd class="nopass">
												<?php echo L('user_not_bound');?> <a href="/user/moble.html"><?php echo L('view');?></a>
											</dd>
										</dl>
										<?php else: ?> <em class="sc_statu_type_2"></em>
										<dl>
											<dt><?php echo L('bound_phone');?></dt>
											<dd class="alpass">
												<?php echo L('user_bound');?> <a href="/user/moble.html"><?php echo L('view');?></a>
											</dd>
										</dl><?php endif; ?>
							 ...
							 <li> 
									<em class="sc_statu_type_2"></em>
											<dl>
												<dt><?php echo L('certification');?></dt>
												<dd class="alpass">
													<?php echo L('user_bound');?> <a href="/user/nameauth.html"><?php echo L('view');?></a>
												</dd>
											</dl>
								</li> 
					        <!-- <li>
					         ...
					         <dl> 
					          ...
					          <dd class="alpass">
					           已绑定 
					           <a href="/user/email.html">查看</a> 
					          </dd> 
					         </dl> </li>  -->
					     </ul> 
					     <div class="sc_info_list" id="sc_info_list"> 
								<dl>
										<dt><?php echo L('login_password');?></dt>
										<dd>
											<p><?php echo L('user_login_password_desc');?></p>
										</dd>
										<dd>
											<div class="changepw">
												<a href="/user/password.html"><?php echo L('user_modify_login_password');?></a>
											</div>
										</dd>
									</dl>
									<dl>
										<dt><?php echo L('trade_password');?></dt>
										<dd>
											<p><?php echo L('user_trade_password_desc');?></p>
										</dd>
										<dd>
											<div class="changepw">
												<a href="/user/paypassword.html"><?php echo L('user_modify_trade_password');?></a>
											</div>
										</dd>
									</dl>
					        <!-- <dl> 
					         <dt>
					          <?php echo L('login_password');?>
					         </dt> 
					         <dd> 
					          <p> 登录账户时需要输入的密码 </p> 
					         </dd> 
					        ...
					        <dl> 
					         ...
					         <dd> 
					          <div class="changepw"> 
					           <a href="/user/paypassword.html"> 修改密码 </a> 
					          </div> 
					         </dd> 
					        </dl>  -->
					  </div> 
