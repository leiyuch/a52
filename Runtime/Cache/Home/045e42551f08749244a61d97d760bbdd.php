		...
		<section class="box-content">
			    ...
			    <div class="main-content clearfix">
				    <div class="now"> 
					    ...
					    <a href="<?php echo U('User/index');?>" class="movesay"><?php echo L('security');?> </a> &gt;<?php echo L('user_bound_alipay');?> 
				    </div>
                 ...
                 <li><a href="<?php echo U('User/log');?>"><i class="fa fa-circle-o"></i> <?php echo L('user_login_log');?></a></li>
				    ...
				    <div class="tag-list-content assets_content bg_w"> 
				     <div class="safe_center clear"> 
				      	<h1> <span> <?php echo L('user_bound_alipay');?> </span> <span> <a class="right" onclick="$('#hints').slideToggle();"> <i class="fa fa-hand-o-right move fz_14 mr5"></i> <span class="fz_12 move">帮助</span> </a> </span> </h1> 
				     </div> 
				     
				     <div class="step1 pwtrade" style="display: block;">
	                    <dl>
	                        <dt></dt>
	                        <dd class="band_succ move">
	                            <i class="fa fa-check mr5"></i><?php echo L('user_alipay_update');?> </dd>
	                    </dl>
	                    <dl>
	                        <dt><?php echo L('user_alipay_account');?>：</dt>
	                        <dd>
									<input type="hidden" name="smsid" value="3" id="smsid">
	                            <input type="text" tabindex="2" id="alipay" class="texts">
	                        </dd>
	                    </dl>
	                    <dl>
	                        <dt><?php echo L('trade_password');?>：</dt>
	                        <dd>
	                            <input type="password" tabindex="3" id="paypassword" class="texts">
	                        </dd>
	                    </dl>
	                    <dl>
	                        <dt></dt>
	                        <dd>
	                            <input type="button" tabindex="4" class="btns2" value="<?php echo L('user_bound_alipay');?>" onclick="Update()">
	                        </dd>
	                    </dl>
	...
	<script>
		  function Update() {
            ...
            if (alipay == "" || alipay == null) {
                layer.tips('<?php echo L('user_enter_alipay_account');?>', '#alipay', {tips: 3});
            return false;
        }
        ...
        $.post("<?php echo U('User/upalipay');?>", {
            alipay: alipay,
            paypassword: paypassword
        }, function (data) {
            if (data.status == 1) {
                layer.msg(data.info, {icon: 1});
                window.location = "<?php echo U('User/alipay');?>";
            } else {
