		...
		<section class="box-content">
			    ...
			    <div class="main-content clearfix">
				    <div class="now"> 
					    ...
					    <a href="<?php echo U('User/index');?>" class="movesay"><?php echo L('security');?> </a> &gt; <?php echo L('user_modify_login_password');?>
				    </div>
                 ...
                 <li><a href="<?php echo U('User/log');?>"><i class="fa fa-circle-o"></i> <?php echo L('user_login_log');?></a></li>
				    ...
				    <div class="tag-list-content assets_content bg_w"> 
				     <div class="safe_center clear"> 
				      	<h1> <span> <?php echo L('user_modify_login_password');?> </span> <span> <a class="right" onclick="$('#hints').slideToggle();"> <i class="fa fa-hand-o-right move fz_14 mr5"></i> <span class="fz_12 move">帮助</span> </a> </span> </h1> 
				     </div> 
				     
				     <div class="step1 pwtrade mt40" style="display: block;">
	                    <dl>
	                        <dt><?php echo L('login_password');?></dt>
	                        <dd>
	                            <input type="password" tabindex="2" id="oldpassword" name="oldpassword" class="texts">
	                        </dd>
	                    </dl>
	                    <dl>
	                        <dt><?php echo L('new_login_password');?>：</dt>
	                        <dd>
	                            <input type="password" tabindex="2" id="newpassword" name="newpassword" class="texts">
	                        </dd>
	                    </dl>
	                    <dl>
	                        <dt><?php echo L('user_enter_new_password_again');?>：</dt>
	                        <dd>
	                            <input type="password" tabindex="3" id="repassword" name="repassword" class="texts">
	                        </dd>
	                    </dl>
	                    <dl>
	                        <dt></dt>
	                        <dd>
	                            <input type="button" tabindex="4" class="btns2" value="<?php echo L('save');?>" onclick="Update()">
	                        </dd>
	                    </dl>
...
<span id="go_to_top" class="go-to-top"><i class="fa fa-long-arrow-up"></i></span>
	...
	<script> 
	function Update() {
			$.post("<?php echo U('User/uppassword');?>", {
				...
				if (data.status == 1) {
					...
					window.location = "<?php echo U('User/password');?>";
				} else {
