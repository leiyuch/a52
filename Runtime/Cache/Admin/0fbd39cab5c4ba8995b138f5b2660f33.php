...
<div id="main-content">
	...
	<div id="main" class="main">
		<div class="main-title-h">
			<span class="h1-title">短信配置</span>
		</div>
		<div class="tab-wrap">
			<div class="tab-content">
				<form id="form" action="<?php echo U('Config/mobleEdit');?>" method="post" class="form-horizontal">
					<div id="tab" class="tab-pane in tab">
						<div class="form-item cf">
							<table>
								<tr class="controls">
									<td class="item-label">短信接口URL :</td>
									<td>
										<input type="text" class="form-control input-10x" id="moble_url" name="moble_url" value="<?php echo ($C['moble_url']); ?>">
									</td>
									<td class="item-note">短信接口URL 接口申请地址:<a href="http://www.webchinese.com.cn/" target="_blank">立即申请</a>
									</td>
								</tr>
								<tr class="controls">
									<td class="item-label">短信接口名称 :</td>
									<td>
										<input type="text" class="form-control input-10x" id="moble_user" name="moble_user" value="<?php echo ($C['moble_user']); ?>">
									</td>
									<td class="item-note">短信接口用户名</td>
								</tr>
								<tr class="controls">
									<td class="item-label">短信接口安全码 :</td>
									<td>
										<input type="password" class="form-control input-10x" id="moble_pwd" name="moble_pwd" value="<?php echo ($C['moble_pwd']); ?>">
									</td>
									<td class="item-note">短信接口安全秘钥</td>
								</tr>
								<tr class="controls">
