...
<div id="main-content">
    ...
    <div id="main" class="main">
        <div class="main-title-h">
            ...
            <?php if(!empty($name)): ?><span class="h2-title">>><a href="<?php echo U('User/coin');?>">财产列表</a></span><?php endif; ?>
        </div>

        <div class="tab-wrap">

            <div class="tab-content">
                <form id="form" action="<?php echo U('User/coinEdit');?>" method="post" class="form-horizontal">
                        ...
                        <div class="form-item cf">
                            <table>
                                ...
                                <tr class="controls">
                                 ...
                                 <tr class="controls">
                                        <td class="item-label">可用积分:</td>

                                        <td><input type="text" class="form-control input-10x" name="integral"
                                                   value="<?php echo ($data["integral"]); ?>"></td>
                                        <td class="item-note">请谨慎修改</td>

                                    </tr>

                                <?php $_result=C('coin');if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="controls">
                                        <td class="item-label">可用<?php echo ($v['title']); ?> :</td>

                                        <td><input type="text" class="form-control input-10x" name="<?php echo ($v['name']); ?>"
                                                   value="<?php echo ($data[$v['name']]*1); ?>"></td>
                                        <td class="item-note">请谨慎修改</td>
