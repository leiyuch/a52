...
<div id="main-content">
 ...
 <div id="main" class="main">
     <div class="main-title-h">
         <span class="h1-title">广告用户管理</span>
     </div>
   ...
   <table class="">
    ...
    <tbody>
     <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
       ...
       <td><?php echo ($vo["vip_name"]); ?>(级别:<?php echo ($vo["tag"]); ?>)</td>
       <td>
          <a href="<?php echo U('App/ads_user_detail?uid='.$vo['uid']);?>" class="btn btn-success btn-xs">点击日志</a>
