...
<span class="h1-title"><a href="<?php echo U('Money/index');?>">理财管理</a> >></span>
   <span class="h1-title"><?php if(empty($data)): ?>添加理财<?php else: ?>编辑理财<?php endif; ?></span>
  </div>
  <div class="tab-wrap">
   <div class="tab-content">
    <form id="form" action="<?php echo U('Money/save');?>" method="post" class="form-horizontal">
     <div id="tab" class="tab-pane in tab">
      <div class="form-item cf">
       <table>
        <tr class="controls">
         <td class="item-label">理财名称 :</td>
         <td><input type="text" class=" form-control input-4x" name="name" value="<?php echo ($data["name"]); ?>"></td>
        ...
        <tr class="controls">
         ...
         <td>
          <?php if(empty($data)): ?><select name="coinname" class="input-small">
                <?php if(is_array($C['coin_list'])): $i = 0; $__LIST__ = $C['coin_list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v['name']); ?>"<?php if(($data['coinname']) == $v['name']): ?>selected<?php endif; ?>><?php echo ($v['title']); ?>
                 </option><?php endforeach; endif; else: echo "" ;endif; ?>
               </select>
           <?php else: ?>
             <?php echo ($data['coinname']); endif; ?>
         </td>
         <td class="item-note"></td>
        </tr>
        ...
        <tr class="controls">
         ...
         <td>
          <?php if(empty($data)): ?><select id="type" name="type" class="input-small">
                 <option value="1" <?php if(($data['type']) == "1"): ?>selected<?php endif; ?>>活期模式</option>
                 <option value="2" <?php if(($data['type']) == "2"): ?>selected<?php endif; ?>>定期模式</option>
                </select>
           <?php else: ?>
           <?php if(($data['type']) == "1"): ?>活期模式<?php else: ?> 定期模式<?php endif; endif; ?>

         </td>
         <td class="item-note">活期模式:可随时提取(扣取手续费) 定期模式:只能到期取</td>
        </tr>

        <tr id="outfee" class="controls" <?php if(($data['type']) == "2"): ?>style="display: none"<?php endif; ?>>
         <td class="item-label">手续费 :</td>
         <td>
          <input type="text" class="form-control  input-4x " name="outfee" value="<?php echo ($data['outfee']*1); ?>">
         </td>
        ...
        <tr class="controls">
         ...
         <td><input type="text" class="form-control input-4x " name="num" value="<?php echo ($data['num']*1); ?>"></td>
         <td class="item-note"></td>
        </tr>
        ...
        <tr class="controls">
         ...
         <td><input type="text" class="form-control  input-4x " name="deal" value="<?php echo ($data['deal']*1); ?>"
          <?php if(!empty($data)): ?>readonly<?php endif; ?> ></td>
         <td class="item-note"></td>
        </tr>
        ...
        <tr class="controls">
         ...
         <td>
          <input type="text" class="form-control  input-2x " style="display: inline;" name="tian" value="<?php echo ($data['tian']*1); ?>" <?php if(!empty($data)): ?>readonly<?php endif; ?> >
          <select name="danwei" class="form-control  input-2x" style="display: inline;" <?php if(!empty($data)): ?>readonly<?php endif; ?> >
            <option value="y"<?php if(($data['danwei']) == "y"): ?>selected<?php endif; ?>>年</option>
            <option value="m"<?php if(($data['danwei']) == "m"): ?>selected<?php endif; ?>>月</option>
            <option value="d"<?php if(($data['danwei']) == "d"): ?>selected<?php endif; ?>>日</option>
            <option value="h"<?php if(($data['danwei']) == "h"): ?>selected<?php endif; ?>>时</option>
            <option value="i"<?php if(($data['danwei']) == "i"): ?>selected<?php endif; ?>>分</option>
           </volist>
          </select>
        ...
        <tr class="controls">
         ...
         <td><input type="text" class="form-control  input-4x " name="lnum" value="<?php echo ($data['lnum']*1); ?>"></td>
        ...
        <tr class="controls">
         ...
         <td><input type="text" class="form-control  input-4x " name="fee" value="<?php echo ($data['fee']*1); ?>"></td>
         <td class="item-note">%</td>
        </tr>
        ...
        <tr class="controls">
         ...
         <td>
          ...
          <?php if(empty($data)): ?><select name="feecoin" class="input-small">
            <?php if(is_array($C['coin_list'])): $i = 0; $__LIST__ = $C['coin_list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v['name']); ?>"<?php if(($data['feecoin']) == $v['name']): ?>selected<?php endif; ?>><?php echo ($v['title']); ?>
             </option><?php endforeach; endif; else: echo "" ;endif; ?>
           </select>
           <?php else: ?>
           <?php echo ($data['feecoin']); endif; ?>
        ...
        <!--<tr class="controls">-->
         ...
         <!--<td><input type="text" class="form-control  input-4x " name="addtime" value="<?php echo (addtime($data['addtime'])); ?>"  onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})"></td>-->
         <!--<td class="item-note"></td>-->
        <!--</tr>-->

        <tr class="controls">
         <td class="item-label">结束时间 :</td>
         <td><input type="text" class="form-control  input-4x " name="endtime" value="<?php echo (addtime($data['endtime'])); ?>"  onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})"></td>
         <td class="item-note"></td>
        </tr>
        ...
        <tr class="controls">
         ...
         <td><input type="text" class="form-control  input-4x " name="sort" value="<?php echo ($data['sort']*1); ?>"></td>
         <td class="item-note"></td>
        </tr>
        ...
        <tr class="controls">
         ...
         <td><select name="status" class="input-small">
           <option value="1"<?php if(($data["status"]) == "1"): ?>selected<?php endif; ?>>可用
           </option>
           <option value="0"<?php if(($data["status"]) == "0"): ?>selected<?php endif; ?>>禁用
           </option>
         </select></td>
         <td class="item-note"></td>
        </tr>
