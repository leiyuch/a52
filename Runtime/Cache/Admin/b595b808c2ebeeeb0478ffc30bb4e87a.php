        ...
        <div class="row state-overview">
            <div class="col-lg-3 col-sm-6">
                <section class="panel">
                    ...
                    <div class="value">
                        <h1 class="count" style="font-size: 24px;"><?php echo ($arr['reg_sum']); ?></h1>
            ...
            <div class="col-lg-3 col-sm-6">
                <section class="panel">
                    ...
                    <div class="value">
                        <h1 class=" count2" style="font-size: 24px;"><?php echo ($arr['cny_num']); ?></h1>
            ...
            <div class="col-lg-3 col-sm-6">
                <section class="panel">
                    ...
                    <div class="value">
                        <h1 class=" count3" style="font-size: 24px;"><?php echo ($arr['trance_mum']); ?></h1>
            ...
            <div class="col-lg-3 col-sm-6">
                <section class="panel">
                    ...
                    <div class="value">
                        <h1 class=" count4" style="font-size: 24px;"><?php echo ($arr['art_sum']); ?></h1>
                                    ...
                                    <div class="sys-info">
                                        <table>
                                            <tr>
                                                <th>系统版本</th>
                                                <td>
                                                    <font class="version" style="color: green">
                                                        V<?php echo file_get_contents('./Database/version.ini');?>
                                                    </font>
                                                    正版授权
                                                </td>
                                            </tr>
                                    ...
                                    <div class="sys-info">
                                        <table>
                                            ...
                                            <!--<tr>
                                                <td>网站开发</td>
                                                <td>
                                                    <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=2338342183&site=qq&menu=yes">
                                                        <img style="margin: -15px 0;" border="0" src="http://wpa.qq.com/pa?p=2:2338342183:51" alt="点击这里给我发消息" title="点击这里给我发消息"/>
                                                    </a></td>
                                            </tr>-->
                                            <tr>
                                                <td>官方网址</td>
                                                <td><a href="http://eumeciin.com/">http://eumeciin.com/</a></td>
                                            </tr>
                                            <tr>
                                                <td>版权所有</td>
                                                <td><a href="#">eumeciin科技</a>版权所有,未经许可,请勿传播!
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>风险警告</td>
                                                <td>为保障程序正常运行,请勿随意篡改代码!</td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
