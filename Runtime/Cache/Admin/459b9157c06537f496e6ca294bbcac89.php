	...
	<div id="main" class="main">
		...
		<div class="cf">
			<div class="fl">
				...
				<button class="btn ajax-post confirm btn-danger " url="<?php echo U('Config/coinStatus',array('type'=>'delete'));?>" target-form="ids">删 除</button>
		...
		<div class="data-table table-striped">
			<table class="">
				...
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<td><img src="/Upload/coin/<?php echo ($vo["img"]); ?>" height="18px"/></td>
							<td>
								<?php if(($vo["type"]) == "qbb"): ?><a href="<?php echo U('Config/coinInfo?coin='.$vo['name']);?>">钱包信息</a>
									<a href="<?php echo U('Config/coinUser?coin='.$vo['name']);?>">所有账号</a>
									<a href="<?php echo U('Config/coinQing?coin='.$vo['name']);?>">清空地址</a>
									<?php else: ?>
									没有钱包服务器<?php endif; ?>
							</td>
							<td>
...
<script type="text/javascript">
	function chk_qianbao() {
		window.location.href = "<?php echo U('Tools/qianbao');?>";
	}
</script>
