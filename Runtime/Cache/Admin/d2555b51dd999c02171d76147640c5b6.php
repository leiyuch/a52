...
<div id="main-content">
	...
	<div id="main" class="main">
		<div>
			...
			<div class="cf">
				<div class="fl">
					<a class="btn btn-success " href="<?php echo U('User/bankEdit');?>">新 增</a>
					<button class="ajax-post btn  btn-info " url="<?php echo U('User/bankStatus',array('type'=>'resume'));?>" target-form="ids">启 用</button>
					<button class="ajax-post btn  btn-warning  ajax-post" url="<?php echo U('User/bankStatus',array('type'=>'forbid'));?>" target-form="ids">禁 用</button>
					<button class="btn ajax-post confirm btn-danger " url="<?php echo U('Article/bankStatus',array('type'=>'del'));?>" target-form="ids">删 除</button>
				</div>
		...
		<div class="data-table table-striped">
			<table class="">
				...
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<td><a href="<?php echo U('User/bankEdit?id='.$vo['id']);?>" class="btn btn-primary btn-xs">编辑</a>
							</td>
