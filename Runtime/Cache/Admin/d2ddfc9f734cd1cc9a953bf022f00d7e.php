...
<div id="main-content">
	...
	<div id="main" class="main">
		...
		<div class="cf">
			<div class="fl">
				<a class="btn  btn-success" href="<?php echo U('Issue/edit');?>">新 增</a>
				<button class="btn ajax-post  btn-info" url="<?php echo U('Issue/status',array('method'=>'resume'));?>" target-form="ids">启 用</button>
				<button class="btn ajax-post  btn-warning" url="<?php echo U('Issue/status',array('method'=>'forbid'));?>" target-form="ids">禁 用</button>
				<button class="btn ajax-post confirm btn-danger" url="<?php echo U('Issue/status',array('method'=>'delete'));?>" target-form="ids">删 除</button>
			</div>
				...
				<div class="sleft">
					<form name="formSearch" id="formSearch" method="get" name="form1">
						...
						<select style=" width: 160px; float: left; margin-right: 10px;" name="field" class="form-control">
							<option value="name"
							<?php if(($_GET['field']) == "name"): ?>selected<?php endif; ?>
							>认购名称</option>
						</select>
		...
		<div class="data-table table-striped">
			<table class="">
				...
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<td><?php echo ($C['coin'][$vo['buycoin']]['title']); ?></td>
							<td><?php echo ($vo['num']*1); ?></td>
							<td><?php echo ($vo['deal']*1); ?></td>
							<td><?php echo ($vo['price']*1); ?></td>
							<td><?php echo ($vo['limit']*1); ?></td>
							<td><?php echo ($vo['ci']); ?></td>
