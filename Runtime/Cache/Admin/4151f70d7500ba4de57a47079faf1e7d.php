    ...
    <div id = "main" class = "main" >
        ...
        <div class = "tab-wrap" >
            <div class = "tab-content" >
                <form id = "form" action = "<?php echo U('App/config');?>" method = "post" class = "form-horizontal" >
                    <div id = "tab" class = "tab-pane in tab" >
                        <div class = "form-item cf" >
                            <table>
                                <input type = "hidden" class = "form-control" name = "id" value = "<?php echo ($appCon['id']); ?>" ></td>
                                <tr class = "controls" >
                                    <td class = "item-label" >APP显示名称 :</td >
                                    <td >
                                        <input type = "text" class = "form-control" name = "web_name" value = "<?php echo ($appCon['web_name']); ?>" >
                                    </td >
                                    <td class = "item-note" ></td >
                                </tr >

                                <tr class = "controls" >
                                    <td class = "item-label" >APP显示标题 :</td >
                                    <td >
                                        <input type = "text" class = "form-control" name = "web_title" value = "<?php echo ($appCon['web_title']); ?>" >
                                    </td >
                                    <td class = "item-note" ></td >
                                </tr >
                                <tr class = "controls" >
                                    <td class = "item-label" >APP显示备案号 :</td >
                                    <td >
                                        <input type = "text" class = "form-control" name = "web_icp" value = "<?php echo ($appCon['web_icp']); ?>" >
                                    </td >
                                    <td class = "item-note" ></td >
                                </tr >

                                <tr class = "controls" >
                                    <td class = "item-label" >APP启动页图片 :</td >
                                    <td >
                                        <textarea name = "index_img" class = "form-control" style = "width: 300px;" ><?php echo ($appCon['index_img']); ?></textarea >
                                    </td >
                                    <td class = "item-note" >一行一个图片链接</td >
                                </tr >

                                <!--//支付宝充值信息-->
                                <tr class = "controls" >
                                    <td class = "item-label" >支付宝信息 :</td >
                                    <td >
                                        支付宝户主:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type = "text" class = "" name = "pay[alipay][name]" value = "<?php echo ($appCon['pay']['alipay']['name']); ?>" >
                                        支付宝账号:&nbsp;<input type = "text" class = "" name = "pay[alipay][value]" value = "<?php echo ($appCon['pay']['alipay']['value']); ?>" >
                                    </td >
                                    <td class = "item-note" >不填写默认不显示</td >
                                </tr >

                                <!--//网银充值信息-->
                                <tr class = "controls" >
                                    <td class = "item-label" >网银信息 :</td >
                                    <td >
                                        网银户主(开户行):&nbsp;<input type = "text" class = "" name = "pay[bank][name]" value = "<?php echo ($appCon['pay']['bank']['name']); ?>" >
                                        网银账号:&nbsp;&nbsp;&nbsp;&nbsp;<input type = "text" class = "" name = "pay[bank][value]" value = "<?php echo ($appCon['pay']['bank']['value']); ?>" >
                                    </td >
                                    <td class = "item-note" >不填写默认不显示</td >
                                </tr >
                                ...
                                <tr><td>&nbsp;</td></tr>
                                <tr class = "controls" >
                                    <td class = "item-label" >提现说明文字 :</td >
                                    <td >
                                        <textarea name = "withdraw_notice" class = "form-control" style = "height: 80px;" ><?php echo ($appCon['withdraw_notice']); ?></textarea >
                                    </td >
                                    <td class = "item-note" ></td >
                                </tr >
                                <tr><td>&nbsp;</td></tr>
                                <tr class = "controls" >
                                    <td class = "item-label" >充值说明文字 :</td >
                                    <td >
                                        <textarea name = "charge_notice" class = "form-control" style = "height: 80px;" ><?php echo ($appCon['charge_notice']); ?></textarea >
                                    </td >
                                    <td class = "item-note" ></td >
                                </tr >
                                <tr><td>&nbsp;</td></tr>
                                <tr class = "controls" style="border: solid 1px red;">
                                    <td class = "item-label" >APP上架币种 :</td >
                                    <td >
                                        <div style="width: 500px;text-align: left">
                                            <?php if(is_array($appCon["show_coin"])): $i = 0; $__LIST__ = $appCon["show_coin"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$show_coin): $mod = ($i % 2 );++$i;?><label style="margin-left: 15px;"><input name="show_coin[]" type = "checkbox"
                                                    <?php if(($show_coin["flag"]) == "1"): ?>checked<?php endif; ?>
                                                    value="<?php echo ($show_coin['id']); ?>"/><?php echo ($show_coin['name']); ?> </label ><?php endforeach; endif; else: echo "" ;endif; ?>
                                        </div>
                                    </td >
                                    <td class = "item-note" ></td >
                                </tr >
                                <tr><td>&nbsp;</td></tr>
                                <tr class = "controls" style="border: solid 1px green;margin-top: 10px" >
                                    <td class = "item-label" >APP上架市场 :</td >
                                    <td >
                                        <div style="width: 500px;text-align: left">
                                            <?php if(is_array($appCon["show_market"])): $i = 0; $__LIST__ = $appCon["show_market"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$show_market): $mod = ($i % 2 );++$i;?><label style="margin-left: 15px;"><input name="show_market[]" type = "checkbox"
                                                    <?php if(($show_market["flag"]) == "1"): ?>checked<?php endif; ?>
                                                    value="<?php echo ($show_market['id']); ?>"/><?php echo ($show_market['name']); ?> </label ><?php endforeach; endif; else: echo "" ;endif; ?>
                                        </div>
                                    </td >
                                    <td class = "item-note" ></td >
                                </tr >
