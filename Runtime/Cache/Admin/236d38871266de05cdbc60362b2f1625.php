...
<div id="main-content">
	...
	<div id="main" class="main">
		<div class="main-title-h">
			<span class="h1-title"><a href="<?php echo U('Article/adver');?>">广告管理</a></span>
		</div>
		<div class="cf">
			<div class="fl">
				<a class="btn btn-success " href="<?php echo U('Article/adverEdit');?>">新 增</a>
				<button class="btn ajax-post btn-info " url="<?php echo U('Article/adverStatus',array('type'=>'resume'));?>" target-form="ids">启 用</button>
				<button class="btn ajax-post btn-warning " url="<?php echo U('Article/adverStatus',array('type'=>'forbid'));?>" target-form="ids">禁 用</button>
				<button class="btn ajax-post confirm btn-danger " url="<?php echo U('Article/adverStatus',array('type'=>'del'));?>" target-form="ids">删 除</button>
			</div>
		...
		<div class="data-table table-striped">
			<table class="">
				...
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<td><img src="/Upload/ad/<?php echo ($vo["img"]); ?>" height="18px"/></td>
							...
							<td>
								<a href="<?php echo U('Article/adverEdit?id='.$vo['id']);?>" class="btn btn-primary btn-xs">编辑</a>
...
//			});
	...
	<script type="text/javascript" charset="utf-8">
		//导航高亮
		highlight_subnav("<?php echo U('Article/adver');?>");
	</script>