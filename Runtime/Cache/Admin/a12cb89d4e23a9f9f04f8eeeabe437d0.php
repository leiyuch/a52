...
<div id="main-content">
	...
	<div id="main" class="main">
		<div class="main-title-h">
			<span class="h1-title">人民币充值方式</span>
		</div>
		<div class="cf">
			<div class="fl">
				<button class="btn ajax-post btn-info" url="<?php echo U('Finance/myczTypeStatus',array('type'=>'resume'));?>" target-form="ids">启 用</button>
				<button class="btn ajax-post btn-warning " url="<?php echo U('Finance/myczTypeStatus',array('type'=>'forbid'));?>" target-form="ids">禁 用</button>
			</div>
		</div>
		<div class="data-table table-striped">
			<table class="">
				...
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<td>
								<a href="<?php echo U('Finance/myczTypeEdit?id='.$vo['id']);?>" class="btn btn-primary btn-xs">编辑 </a>
							</td>
...
//			});
	...
	<script type="text/javascript" charset="utf-8">
		//导航高亮
		highlight_subnav("<?php echo U('Finance/myczType');?>");
	</script>