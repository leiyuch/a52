...
<div id="main-content">
    ...
    <div id="main" class="main">
        <div class="main-title-h">
            <span class="h1-title">交易推荐</span>
            <?php if(!empty($name)): ?><span class="h1-title">>><a href="<?php echo U('Trade/invit');?>">推广列表</a></span><?php endif; ?>
        </div>
        <div class="cf">
            <div class="fl"></div>
...
//			});
    ...
    <script type="text/javascript" charset="utf-8">
        //导航高亮
        highlight_subnav("<?php echo U('Trade/invit');?>");
    </script>