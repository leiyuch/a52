...
<div id="main-content">
    ...
    <div id="main" class="main">
        <div class="main-title-h">
            ...
            <span class="h1-title"><?php if(empty($data)): ?>添加币种
                <?php else: ?>
                                                      编辑币种<?php endif; ?></span>
        ...
        <div class="tab-wrap">
            ...
            <div class="tab-content">
                <form id="form" action="<?php echo U('Config/coinEdit');?>" method="post" class="form-horizontal"
                        ...
                        <div class="form-item cf">
                            <table>
                                ...
                                <tr class="controls">
                                    ...
                                    <td><input type="text" class="form-control input-10x" name="js_yw" value="<?php echo ($data['js_yw']); ?>">
                                    </td>
                                ...
                                <tr class="controls">
                                    ...
                                    <td><input type="text" class="form-control input-10x" name="title" value="<?php echo ($data['title']); ?>">
                                    </td>
                                ...
                                <tr class="controls">
                                    ...
                                    <td><select name="type" class="form-control input-10x">
                                        <option value="rgb"
                                        <?php if(($data["type"]) == "rgb"): ?>selected<?php endif; ?>
                                        >认购币
                                        </option>
                                        <option value="qbb"
                                        <?php if(($data["type"]) == "qbb"): ?>selected<?php endif; ?>
                                        >钱包币
                                        </option>
                                    </select></td>
                                    <td class="item-note"></td>
                                    ...
                                    <td>
                                        <div id="addpicContainer">
                                            ...
                                            <?php if(!empty($data["img"])): ?><!--没有图片显示默认图片-->
                                                <img id="up_img" onclick="getElementById('inputfile').click()" style="cursor:pointer;max-width:500px;" title="点击添加图片" alt="点击添加图片" src="/Upload/coin/<?php echo ($data["img"]); ?>">
                                                <?php else: ?>
                                                <!--没有图片显示默认图片-->
                                ...
                                <tr class="controls">
                                    ...
                                    <td><input type="text" class="form-control input-10x" name="dj_zj" value="<?php echo ($data['dj_zj']); ?>">
                                    </td>
                                ...
                                <tr class="controls">
                                    ...
                                    <td><input type="text" class="form-control input-10x" name="dj_dk" value="<?php echo ($data['dj_dk']); ?>">
                                    </td>
                                ...
                                <tr class="controls">
                                    ...
                                    <td><input type="text" class="form-control input-10x" name="dj_yh" value="<?php echo ($data['dj_yh']); ?>" autocomplete="off" aria-autocomplete="none">
                                    </td>
                                ...
                                <tr class="controls">
                                    ...
                                    <td><input type="password" class="form-control input-10x" name="dj_mm"
                                               value="<?php echo ($data['dj_mm']); ?>"  autocomplete="off" aria-autocomplete="none"></td>
                                ...
                                <tr class="controls">
                                    ...
                                    <td><input type="text" class="form-control input-10x" name="fee_bili" value="<?php echo ($data['fee_bili']); ?>">
                                    </td>
                                ...
                                <tr class="controls">
                                    ...
                                    <td><input type="text" class="form-control input-10x" name="fee_meitian" value="<?php echo ($data['fee_meitian']); ?>">
                                    </td>
                                ...
                                <tr class="controls">
                                    ...
                                    <td>
                                        <?php if(empty($data['zr_jz'])): ?><select name="zr_jz" class="form-control input-10x" >
...
-->
                                ...
                                <tr class="controls">
                                    ...
                                    <td>
                                        <?php if(empty($data['zc_min'])): ?><input type="text" class="form-control input-10x" name="zc_min" value="0.01">
                                            <?php else: ?>
                                            <input type="text" class="form-control input-10x" name="zc_min" value="<?php echo ($data['zc_min']); ?>"><?php endif; ?>
                                    <td class="item-note">推荐:正数且大于0.01</td>
                                </tr>
                                <tr class="controls">
                                    <td class="item-label">最大转出数量 :</td>
                                    <td>
                                        <?php if(empty($data['zc_max'])): ?><input type="text" class="form-control input-10x" name="zc_max" value="10000">
                                            <?php else: ?>
                                            <input type="text" class="form-control input-10x" name="zc_max" value="<?php echo ($data['zc_max']); ?>"><?php endif; ?>
                                    <td class="item-note">推荐:正数且大于10000</td>
                                </tr>

								<?php if(($data['id']) == "10"): ?><tr class="controls">
                                    <td class="item-label">一天最多挂买几次 :</td>
                                    <td>
                                        <?php if(empty($data['max_leiji'])): ?><input type="text" class="form-control" name="max_leiji" value="3">
                                            <?php else: ?>
                                            <input type="text" class="form-control" name="max_leiji" value="<?php echo ($data['max_leiji']); ?>"><?php endif; ?>
                                    <td class="item-note">正数且大于1,如果超过 这个数字之后不能挂卖单</td>
                                </tr>
								 <tr class="controls">
                                    <td class="item-label">每次交易消耗信用积分 :</td>
                                    <td>
                                        <?php if(empty($data['max_meitian'])): ?><input type="text" class="form-control" name="max_meitian" value="40">
                                            <?php else: ?>
                                            <input type="text" class="form-control" name="max_meitian" value="<?php echo ($data['max_meitian']); ?>"><?php endif; ?>
                                    <td class="item-note"> %  0-100之前的一个整数</td>
                                </tr><?php endif; ?>
                                ...
                                <tr class="controls">
                                    ...
                                    <td>
                                        <?php if(empty($data['zc_zd'])): ?><input type="text" class="form-control input-10x" name="zc_zd" value="100">
                                            <?php else: ?>
                                ...
                                <!--<tr class="controls">-->
                                    ...
                                    <!--<td><textarea name="zr_sm"><?php echo ($data["zr_sm"]); ?></textarea></td>-->
                                    <!--<td class="item-note"></td>-->
                                <!--</tr>-->
                                <!--<tr class="controls">-->
                                    <!--<td class="item-label">转出说明 :</td>-->
                                    <!--<td><textarea name="zc_sm"><?php echo ($data["zc_sm"]); ?></textarea></td>-->
                                    <!--<td class="item-note"></td>-->
                                <!--</tr>-->
                                ...
                                <tr class="controls">
                                    ...
                                    <td><textarea name="js_sm" class="form-control input-10x"><?php echo ($data["js_sm"]); ?></textarea></td>
                                    <td class="item-note"></td>
                                </tr>
                                
                                <tr class="controls">
                                    <td class="item-label">英文详细介绍:</td>
                                    <td><textarea name="js_sm_en" class="form-control input-10x"><?php echo ($data["js_sm_en"]); ?></textarea></td>
                                    <td class="item-note"></td>
                                </tr>
                                ...
                                <tr class="controls">
                                    ...
                                    <td><input type="text" class="form-control input-10x" name="js_qb" value="<?php echo ($data['js_qb']); ?>">
                                    </td>
                                ...
                                <tr class="controls">
                                    ...
                                    <td><input type="text" class="form-control input-10x" name="js_ym" value="<?php echo ($data['js_ym']); ?>">
                                    </td>
                                ...
                                <tr class="controls">
                                    ...
                                    <td><input type="text" class="form-control input-10x" name="js_gw" value="<?php echo ($data['js_gw']); ?>">
                                    </td>
                                ...
                                <tr class="controls">
                                    ...
                                    <td><input type="text" class="form-control input-10x" name="js_lt" value="<?php echo ($data['js_lt']); ?>">
                                    </td>
                                ...
                                <tr class="controls">
                                    ...
                                    <td><input type="text" class="form-control input-10x" name="js_wk" value="<?php echo ($data['js_wk']); ?>">
                                    </td>
                                    <td class="item-note"></td>
                                </tr>
                                ...
                                <tr class="controls">
                                    ...
                                    <td><input type="text" class="form-control input-10x" name="cs_yf" value="<?php echo ($data['cs_yf']); ?>">
                                    </td>
                                    <td class="item-note"></td>
                                </tr>
                                <tr class="controls">
                                    <td class="item-label">核心算法:</td>
                                    <td><input type="text" class="form-control input-10x" name="cs_sf" value="<?php echo ($data['cs_sf']); ?>">
                                    </td>
                                    <td class="item-note"></td>
                                </tr>
                                <tr class="controls">
                                    <td class="item-label">发布日期 :</td>
                                    <td><input type="text" class="form-control input-10x" name="cs_fb" value="<?php echo ($data['cs_fb']); ?>">
                                    </td>
                                    <td class="item-note"></td>
                                </tr>
                                <tr class="controls">
                                    <td class="item-label">证明方式 :</td>
                                    <td><input type="text" class="form-control input-10x" name="cs_zm" value="<?php echo ($data['cs_zm']); ?>">
                                    </td>
                                    <td class="item-note"></td>
                                </tr>
                                ...
                                <tr class="controls">
                                    ...
                                    <td><input type="text" class="form-control input-10x" name="cs_qk" value="<?php echo ($data['cs_qk']); ?>">
                                    </td>
                                    <td class="item-note"></td>
                                </tr>
                                <tr class="controls">
                                    <td class="item-label">发行总量 :</td>
                                    <td><input type="text" class="form-control input-10x" name="cs_zl" value="<?php echo ($data['cs_zl']); ?>">
                                    </td>
                                    <td class="item-note"></td>
                                </tr>
                                ...
                                <tr class="controls">
                                    ...
                                    <td><input type="text" class="form-control input-10x" name="cs_cl" value="<?php echo ($data['cs_cl']); ?>">
                                    </td>
                                    <td class="item-note"></td>
                                </tr>
                                <tr class="controls">
                                    <td class="item-label">难度调整 :</td>
                                    <td><input type="text" class="form-control input-10x" name="cs_nd" value="<?php echo ($data['cs_nd']); ?>">
                                    </td>
                                    <td class="item-note"></td>
                                </tr>
                                <tr class="controls">
                                    <td class="item-label">区块奖励 :</td>
                                    <td><input type="text" class="form-control input-10x" name="cs_jl" value="<?php echo ($data['cs_jl']); ?>">
                                    </td>
                                    <td class="item-note"></td>
                                </tr>
                                <tr class="controls">
                                    <td class="item-label">主要特色 :</td>
                                    <td><input type="text" class="form-control input-10x" name="cs_ts" value="<?php echo ($data['cs_ts']); ?>">
                                    </td>
                                    <td class="item-note"></td>
                                </tr>
                                <tr class="controls">
                                    <td class="item-label">不足之处 :</td>
                                    <td><input type="text" class="form-control input-10x" name="cs_bz" value="<?php echo ($data['cs_bz']); ?>">
                                    </td>
                                    <td class="item-note"></td>
                                </tr>
