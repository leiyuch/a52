	...
	<div id="main" class="main">
		...
		<div class="tab-wrap">
			<div class="tab-content">
				<form id="form" action="<?php echo U('Config/contactEdit');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
					<div id="tab" class="tab-pane in tab">
						<div class="form-item cf">
							<table>
								<tr class="controls">
									<td class="item-label">联系手机:</td>
									<td>
										<input type="text" class="form-control input-10x" name="contact_moble" value="<?php echo ($C['contact_moble']); ?>">
									</td>
									<td class="item-note">联系手机</td>
								</tr>
								<tr class="controls">
									<td class="item-label">联系新浪微博:</td>
									<td>
										<input type="text" class="form-control input-10x" name="contact_weibo" value="<?php echo ($C['contact_weibo']); ?>">
									</td>
								...
								<tr class="controls">
									...
									<td>
										<input type="text" class="form-control input-10x" name="contact_tqq" value="<?php echo ($C['contact_tqq']); ?>">
									</td>
								...
								<tr class="controls">
									...
									<td>
										<input type="text" class="form-control input-10x" name="contact_qq" value="<?php echo ($C['contact_qq']); ?>">
									</td>
								...
								<tr class="controls">
									...
									<td>
										<input type="text" class="form-control input-10x" name="contact_qqun" value="<?php echo ($C['contact_qqun']); ?>">
									</td>
