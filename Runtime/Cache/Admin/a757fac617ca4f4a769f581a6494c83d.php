...
<div id="main-content">
	...
	<div id="main" class="main">
		<div class="main-title-h">
			<span class="h1-title"><a href="<?php echo U('User/goods');?>">联系地址</a> >></span>
		...
		<div class="tab-wrap">
			<div class="tab-content">
				<form id="form" action="<?php echo U('User/goodsEdit');?>" method="post" class="form-horizontal">
