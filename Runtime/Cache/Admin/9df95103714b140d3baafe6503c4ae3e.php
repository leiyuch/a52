					...
					<div id="tab" class="tab-pane in tab">
						<div class="form-item cf">
							<table>
								<table>
									<tr class="controls">
										<td class="item-label">最小提现金额 :</td>
										<td>
											<input type="text" class="form-control input-10x" name="mytx_min" value="<?php echo ($C['mytx_min']); ?>">
										</td>
										<td class="item-note">最小提现金额</td>
									</tr>
									<tr class="controls">
										<td class="item-label">最大提现金额 :</td>
										<td>
											<input type="text" class="form-control input-10x" name="mytx_max" value="<?php echo ($C['mytx_max']); ?>">
										</td>
										<td class="item-note">最大提现金额</td>
									</tr>
									<tr class="controls">
										<td class="item-label">提现整倍数 :</td>
										<td>
											<input type="text" class="form-control input-10x" name="mytx_bei" value="<?php echo ($C['mytx_bei']); ?>">
										</td>
										<td class="item-note">提现整倍数</td>
									</tr>
									<tr class="controls">
										<td class="item-label">提现手续费 :</td>
										<td>
											<input type="text" class="form-control input-10x" name="mytx_fee" value="<?php echo ($C['mytx_fee']); ?>">
										</td>
										<td class="item-note">%提现手续费</td>
									</tr>
									<tr class="controls">
