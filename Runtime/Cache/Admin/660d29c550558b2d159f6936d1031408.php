...
<div id="main-content">
 ...
 <div id="main" class="main">
  <div class="main-title-h">
   <span class="h1-title">推广管理</span>
   <?php if(!empty($name)): ?><span class="h2-title">>><a href="<?php echo U('Invit/index');?>">推广列表</a></span><?php endif; ?>
  </div>
  <div class="cf">
   <div class="fl"></div>
   <div class="search-form fr cf">
    <div class="sleft">
     <form name="formSearch" id="formSearch" method="get" name="form1" action="<?php echo U('Invit/index');?>">
      <input type="text" name="name" class="search-input" value="<?php echo ($name); ?>" placeholder="请输入用户名"> <a class="sch-btn" href="javascript:;" id="search"><i class="btn-search"></i></a>
     </form>
     <script>
						//搜索功能
						$(function(){
