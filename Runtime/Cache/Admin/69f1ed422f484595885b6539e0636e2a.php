...
<div id="main-content">
	...
	<div id="main" class="main">
		...
		<div class="cf">
			<div class="fl">
				<button class="btn ajax-post confirm btn-danger " url="<?php echo U('Trade/commentStatus',array('type'=>'del'));?>" target-form="ids">删 除
				</button>
			</div>
		...
		<div class="data-table table-striped">
			<table class="">
				...
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<td><?php echo ($vo['cjz']); ?></td>
							<td><?php echo ($vo['tzy']); ?></td>
							<td><?php echo ($vo['xcd']); ?></td>
...
//			});
	...
	<script type="text/javascript" charset="utf-8">
		//导航高亮
		highlight_subnav("<?php echo U('Trade/comment');?>");
	</script>