	...
	<div id="main" class="main">
		<div class="main-title-h">
			<span class="h1-title"><a href="<?php echo U('User/index');?>">用户管理</a> >></span>
			 <span class="h1-title"><?php if(empty($data)): ?>添加用户
				 <?php else: ?>
			                                           编辑用户<?php endif; ?></span>
		</div>
		<div class="tab-wrap">
						...
						<div class="form-item cf">
							<table>
								...
								<tr class="controls">
									...
									<td>
										<input type="text" class="form-control input-10x" name="moble" value="<?php echo ($data["moble"]); ?>">
									</td>
									<td class="item-note"></td>
								</tr>
								<tr class="controls">
									...
									<td>
										<input type="text" class="form-control input-10x" name="mobletime" value="<?php echo (addtime($data['mobletime'])); ?>" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})">
									</td>
									<td class="item-note"></td>
								</tr>
								<tr class="controls">
								...
								<tr class="controls">
									...
									<td>
										<input type="text" class="form-control input-10x" name="truename" value="<?php echo ($data["truename"]); ?>">
									</td>
									<td class="item-note"></td>
								</tr>
								<tr class="controls">
									...
									<td>
										<input type="text" class="form-control input-10x" name="idcard" value="<?php echo ($data["idcard"]); ?>">
									</td>
									<td class="item-note"></td>
								</tr>
									<tr class="controls">
									...
									<td>
										<input type="text" class="form-control input-10x" name="email" value="<?php echo ($data["email"]); ?>">
									</td>
									<td class="item-note"></td>
								</tr>
								<tr class="controls">
									...
									<td><select name="status" class="form-control input-10x">
										...
										>锁定</option>
											<option value="3"
										<?php if(($data["status"]) == "3"): ?>selected<?php endif; ?>
										>待审核</option>
									</select></td>
									<td class="item-note"></td>
								</tr>
