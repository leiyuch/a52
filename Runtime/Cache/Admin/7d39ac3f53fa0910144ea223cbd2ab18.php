	...
	<div id="main" class="main">
		...
		<div class="cf">
			<div class="fl">
				...
				<button class="ajax-post btn  btn-info " url="<?php echo U('User/qianbaoStatus',array('type'=>'resume'));?>" target-form="ids">启 用</button>
				<button class="ajax-post btn  btn-warning  ajax-post" url="<?php echo U('User/qianbaoStatus',array('type'=>'forbid'));?>" target-form="ids">禁 用</button>
				<button class="btn ajax-post confirm btn-danger " url="<?php echo U('Article/qianbaoStatus',array('type'=>'del'));?>" target-form="ids">删 除</button>
			</div>
