...
<div id="main-content">
	...
	<div id="main" class="main">
		<div class="main-title-h">
			<span class="h1-title"><a href="<?php echo U('Article/type');?>">文章类型</a></span>
		</div>
		<div class="cf">
			<div class="fl">
				<a class="btn btn-success " href="<?php echo U('Article/typeEdit');?>">新 增</a>
				<button class="btn ajax-post btn-info " url="<?php echo U('Article/typeStatus',array('type'=>'resume'));?>" target-form="ids">启 用
				</button>
				<button class="btn ajax-post btn-warning " url="<?php echo U('Article/typeStatus',array('type'=>'forbid'));?>" target-form="ids">禁 用
				</button>
				<button class="btn ajax-post confirm btn-danger " url="<?php echo U('Article/typeStatus',array('type'=>'del'));?>" target-form="ids">删 除
				</button>
			</div>
		...
		<div class="data-table table-striped">
			<table class="">
				...
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<td><a href="<?php echo U('Article/typeEdit?id='.$vo['id']);?>" class="btn btn-primary btn-xs">编辑</a>
							</td>
