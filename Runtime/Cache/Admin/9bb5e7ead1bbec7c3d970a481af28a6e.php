					...
					<div id="tab" class="tab-pane in tab">
						<div class="form-item cf">
							<table>
								...
								<tr class="controls">
									<td class="item-label">英文网站logo :</td>
									<td>
										<div id="addpicContainer">
											<?php if(!empty($data["web_logo_en"])): ?><img id="up_img_en" onclick="getElementById('inputfile_en').click()" style="cursor:pointer;max-width:400px;" title="点击添加图片" alt="点击添加图片" src="/Upload/public/<?php echo ($data["web_logo_en"]); ?>">
												<?php else: ?>
												<img id="up_img_en" onclick="getElementById('inputfile_en').click()" style="cursor:pointer;max-width:400px;" title="点击添加图片" alt="点击添加图片" src="/Public/Admin/images/addimg.png"><?php endif; ?>
											<input type="hidden" id="img_en" name="web_logo_en" value="<?php echo ($data["web_logo_en"]); ?>">
											<input type="file" id="inputfile_en" style="height:0;width:0;z-index: -1; position: absolute;left: 10px;top: 5px;" value=""/>
										</div>
									</td>
									<td class="item-note">250px*34px</td>
								</tr>
								...
								<tr class="controls">
									<td class="item-label">英文网站小logo :</td>
									<td>
										<div id="addpicContainer">
											<?php if(!empty($data["web_llogo_small_en"])): ?><img id="up_imga_en" onclick="getElementById('inputfilea_en').click()" style="cursor:pointer;max-width:400px;" title="点击添加图片" alt="点击添加图片" src="/Upload/public/<?php echo ($data["web_llogo_small_en"]); ?>">
												<?php else: ?>
												<img id="up_imga_en" onclick="getElementById('inputfilea_en').click()" style="cursor:pointer;max-width:400px;" title="点击添加图片" alt="点击添加图片" src="/Public/Admin/images/addimg.png"><?php endif; ?>
											<input type="hidden" id="imga_en" name="web_llogo_small_en" value="<?php echo ($data["web_llogo_small_en"]); ?>">
											<input type="file" id="inputfilea_en" style="height:0;width:0;z-index: -1; position: absolute;left: 10px;top: 5px;" value=""/>
										</div>
									</td>
									<td class="item-note">交易界面显示 168px*22px</td>
								</tr>
								...
								<tr class="controls">
									<td class="item-label">英文网站底部logo :</td>
									<td>
										<div id="addpicContainer">
											<?php if(!empty($data["footer_logo_en"])): ?><img id="up_imgb_en" onclick="getElementById('inputfileb_en').click()" style="cursor:pointer;max-width:400px;" title="点击添加图片" alt="点击添加图片" src="/Upload/public/<?php echo ($data["footer_logo_en"]); ?>">
												<?php else: ?>
												<img id="up_imgb_en" onclick="getElementById('inputfileb_en').click()" style="cursor:pointer;max-width:400px;" title="点击添加图片" alt="点击添加图片" src="/Public/Admin/images/addimg.png"><?php endif; ?>
											<input type="hidden" id="imgb_en" name="footer_logo_en" value="<?php echo ($data["footer_logo_en"]); ?>">
											<input type="file" id="inputfileb_en" style="height:0;width:0;z-index: -1; position: absolute;left: 10px;top: 5px;" value=""/>
										</div>
									</td>
									<td class="item-note">交易界面显示 168px*22px</td>
								</tr>
								...
								<tr class="controls">
									<td class="item-label">英文用户注册协议 :</td>
									<td>
										<textarea name="web_reg_en" class="form-control input-10x"><?php echo ($data['web_reg_en']); ?></textarea>
									</td>
									<td class="item-note"></td>
								</tr>
								<tr class="controls">
...
<script type="text/javascript">
	...
	$(document).ready(function () {
		//响应文件添加成功事件
		$("#inputfile_en").change(function () {
			//创建FormData对象
			var data = new FormData();
			//为FormData对象添加数据
			$.each($('#inputfile_en')[0].files, function (i, file) {
				data.append('upload_file' + i, file);
			});
			...
			$.ajax({
				...
				success: function (data) {
					if (data) {
						$('#up_img_en').attr("src", '/Upload/public/' + data);
						$('#img_en').val(data);
						$('#up_img_en').show();
					}
				},
	...
	$(document).ready(function () {
		//响应文件添加成功事件
		$("#inputfileb_en").change(function () {
			//创建FormData对象
			var data = new FormData();
			//为FormData对象添加数据
			$.each($('#inputfileb_en')[0].files, function (i, file) {
				data.append('upload_file' + i, file);
			});
			...
			$.ajax({
				...
				success: function (data) {
					if (data) {
						$('#up_imgb_en').attr("src", '/Upload/public/' + data);
						$('#imgb_en').val(data);
						$('#up_imgb_en').show();
					}
				},
	...
	$(document).ready(function () {
		//响应文件添加成功事件
		$("#inputfilea_en").change(function () {
			//创建FormData对象
			var data = new FormData();
			//为FormData对象添加数据
			$.each($('#inputfilea_en')[0].files, function (i, file) {
				data.append('upload_file' + i, file);
			});
			...
			$.ajax({
				...
				success: function (data) {
					if (data) {
						$('#up_imga_en').attr("src", '/Upload/public/' + data);
						$('#imga_en').val(data);
						$('#up_imga_en').show();
					}
				},
...
<script type="text/javascript">
	...
	KindEditor.ready(function (K) {
		editor = K.create('textarea[name="web_reg"],textarea[name="web_reg_en"]', {
			width: '500px',
			height: '100px',
