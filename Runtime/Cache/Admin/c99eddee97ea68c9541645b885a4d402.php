...
<div id="main-content">
	...
	<div id="main" class="main">
		...
		<div class="cf">
			<div class="fl">
                <a class="btn btn-success" href="<?php echo U('Trade/log_export', array('start_time'=>I('get.start_time'), 'end_time'=>I('get.end_time'), 'market'=>I('get.market'), 'field'=>I('get.field'), 'name'=>I('get.name')));?>">导出</a>
            </div>
				...
				<div class="sleft">
					<form name="formSearch" id="formSearch" method="get" name="form1">
						...
						<select style=" width: 160px; float: left; margin-right: 10px;" name="field" class="form-control">
							...
							<?php if(($_GET['field']) == "peername"): ?>selected<?php endif; ?>
							>卖家用户名</option>
						</select>
...
//			});
	...
	<script type="text/javascript" charset="utf-8">
		//导航高亮
		highlight_subnav("<?php echo U('Trade/log');?>");
	</script>