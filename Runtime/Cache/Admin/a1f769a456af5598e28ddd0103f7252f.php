...
<div id="main-content">
    ...
    <div id="main" class="main">
        ...
        <div class="cf">
            <div class="fl">
                <a class="btn btn-success " href="<?php echo U('Trade/marketEdit');?>">新 增</a>
                <button class="btn ajax-post btn-info"
                        url="<?php echo U('Trade/marketStatus',array('type'=>'resume'));?>" target-form="ids">启 用
                </button>
                <button class="btn ajax-post btn-warning "
                        url="<?php echo U('Trade/marketStatus',array('type'=>'forbid'));?>" target-form="ids">禁 用
                </button>
                <button class="btn ajax-post confirm btn-danger "
                        url="<?php echo U('Trade/marketStatus',array('type'=>'del'));?>" target-form="ids">删 除
                </button>
            </div>
        ...
        <div class="data-table table-striped">
            <table class="">
                ...
                <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php echo ($vo["fee_sell"]); ?></td>
                            <td><?php echo ($vo["buy_min"]); ?></td>
                            <td><?php echo ($vo["buy_max"]); ?></td>
                            <td><?php echo ($vo["sell_min"]); ?></td>
                            <td><?php echo ($vo["sell_max"]); ?></td>


                            <td>
                                <?php if(($vo["trade"]) == "1"): ?>开启交易
                                    <?php else: ?>
                                    禁止交易<?php endif; ?>
                            </td>
                            <td>
                            ...
                            <td>
                                <?php if(($vo["name"]) != "cny"): ?><a href="<?php echo U('Trade/marketEdit?id='.$vo['id']);?>"
                                                                   class="btn btn-primary btn-xs">编辑</a><?php endif; ?>
                            </td>
