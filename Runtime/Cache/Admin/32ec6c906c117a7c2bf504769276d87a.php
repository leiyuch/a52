            ...
            <form action="<?php echo U('Login/index');?>" method="post" class="login-form">
                ...
                <div id="itemBox" class="item-box">
                    ...
                    <div class="item verifycode">
                        <i class="icon-login-verifycode"></i> <input type="text" id="verify" name="verify" placeholder="请填写验证码"
                                                                     autocomplete="off">
                    ...
                    <div class="item verifycode">
                        <i class="icon-login-verifycode"></i> <input type="text" name="mverify" placeholder="请填写短信验证码"
                                                                     autocomplete="off">
                        <a  title="获取短信" onclick="SendCode()" href="javascript:void(0)">获取短信</a>
                    </div>
                </div>
