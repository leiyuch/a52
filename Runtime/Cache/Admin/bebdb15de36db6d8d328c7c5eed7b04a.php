...
<div id="main-content">
    ...
    <div id="main" class="main">
        ...
        <div class="cf">
            <div class="fl">
                <a class="btn btn-success" href="<?php echo U('Finance/myzc_export', array('start_time'=>I('get.start_time'), 'end_time'=>I('get.end_time'), 'coinname'=>I('get.coinname'), 'field'=>I('get.field'), 'name'=>I('get.name')));?>">导出</a>
            </div>
            <div class="search-form fr cf">
                <div class="sleft">
                    <form name="formSearch" id="formSearch" method="get" name="form1">
                        <input type="text" class="search-input form-control" name="start_time" value="<?php echo ($_GET['start_time']); ?>" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" placeholder="开始时间" style="margin-right: 10px;">
                        <input type="text" class="search-input form-control" name="end_time" value="<?php echo ($_GET['end_time']); ?>" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" placeholder="结束时间" style="margin-right: 10px;">
                        <select style="width: 160px; float: left; margin-right: 10px;" name="coinname" class="form-control">
                            ...
                            >交易币种</option>
                            <?php if(is_array($C['coin'])): $i = 0; $__LIST__ = $C['coin'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['name']); ?>"
        ...
        <div class="data-table table-striped">
            <table class="">
                ...
                <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <?php if(empty($vo['num'])): ?><td style="color: yellowgreen">(<?php echo ($vo['num']); ?>)手续费</td>
                                <?php else: ?>
                                    <td><?php echo ($vo['num']*1); ?></td><?php endif; ?>

                            <?php if(empty($vo['num'])): ?><td style="color: yellowgreen">入账:<?php echo ($vo['fee']); ?></td>
                                <?php else: ?>
