	...
	<div id="main" class="main">
		...
		<div class="cf">
			<div class="fl">
				...
				<button class="btn ajax-post btn-info " url="<?php echo U('User/adminStatus',array('type'=>'resume','moble'=>'Admin'));?>" target-form="ids">启 用
				</button>
				<button class="btn ajax-post btn-warning " url="<?php echo U('User/adminStatus',array('type'=>'forbid','moble'=>'Admin'));?>" target-form="ids">禁 用
				</button>
				<button class="btn ajax-post confirm btn-danger " confirm-msg="批量删除不可恢复,确定删除?" url="<?php echo U('User/adminStatus',array('type'=>'del','moble'=>'Admin'));?>" target-form="ids">删 除
				</button>
			</div>
